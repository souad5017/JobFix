    ...
    <main class="flex-1  p-8 bg-surface-bright min-h-screen">
        ...
        <section class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 m-10">
            ...
            <div class="bg-surface-container-lowest p-8 rounded-lg shadow-[0px_20px_40px_rgba(25,28,30,0.04)] border border-white">
                ...
                <div class="text-5xl font-black text-on-surface mt-2">{{ $amountSum }}<span class="text-2xl font-bold ml-1">MAD</span></div>
            ...
            <div class="bg-orange-600 p-8 rounded-lg shadow-[0px_20px_40px_rgba(243,112,33,0.15)] flex flex-col justify-between text-white">
                <div>
                    <span class="label-md font-bold text-orange-200 uppercase tracking-widest text-[10px]">Avis donnés</span>
                    <div class="text-5xl font-black mt-2">{{ $reviewsCount }}</div>
                </div>
                <div class="mt-2 text-sm text-orange-100 flex items-center gap-2">
                    ...
                    <div class="bg-surface-container-lowest p-6 rounded-lg flex items-center gap-6 shadow-[0px_10px_20px_rgba(0,0,0,0.02)] group hover:shadow-lg transition-shadow">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-3 flex gap-2">
                                ...
                                <a href="{{ route('client.requests.show' , $request->id) }}" class="bg-slate-100 text-slate-700 text-xs font-bold px-4 py-2 rounded-full hover:bg-slate-200 transition-colors">Voir détails</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="bg-surface-container-lowest p-6 rounded-lg shadow-[0px_20px_40px_rgba(25,28,30,0.04)] hover:-translate-y-1 transition-transform duration-300">
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex gap-4">
                                    <div class="w-12 h-12 rounded-xl overflow-hidden">
                                        <img alt="Pro" data-alt="Portrait of a carpenter smiling in his workshop, warm sunset lighting, tools in background"
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center text-xs text-secondary mt-1">
                                            ...
                                            <span class="ml-1 font-bold text-on-surface">{{ round($professional->reviews_avg_rating, 1) }}</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <a href="{{ route('client.professionals.show', $professional->id) }}"
                                class="block w-full text-center py-3 bg-secondary-container text-on-secondary-container font-bold text-xs rounded-full hover:bg-orange-50 hover:text-orange-600 transition-colors">
                                Consulter le profil
                            </a>
                        </div>
                        @empty
